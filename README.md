...
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) bc6fdd58ca5093336df4caaa9235c581
```
Method 2: Install via ghp.ci proxy script
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) bc6fdd58ca5093336df4caaa9235c581
```
...
cursor-vip bc6fdd58ca5093336df4caaa9235c581;
# Windows 
...
1. After cloning this repository, replace `bc6fdd58ca5093336df4caaa9235c581` in the `README` with your DeviceID.
